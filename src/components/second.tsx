...
const SecondSection = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blue-400 to-blue-600 flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 w-full h-full bg-cover bg-center bg-blend-exclusion" style={{ backgroundImage: "url('/background.png')", backgroundSize: 'contain', opacity: 0.5 }} />
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center text-center md:text-left relative z-10">
        ...
        <div className="md:ml-8 max-w-md">
          <div className="flex items-baseline mb-4">
            ...
            <div className="relative inline-block">
              <div className="absolute inset-0 bg-yellow-400 shadow-lg" style={{ width: '100%', height: '100%' }}></div>
