  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blue-200 to-blue-400 flex flex-col items-center justify-center overflow-hidden">
      <div className="text-center z-10 p-4 sm:p-6 md:p-8 lg:p-10">
        <div className="relative mb-5 mt-5 flex flex-col items-center justify-center">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white"> Get To Know Chemistry Week 16 </h1>
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-yellow-400 mt-2"> "Green Horizons Alliance" </h2>
        ...
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-black mt-8 font-montserrat font-extrabold">
          Uniting for Nature: Together, Let's Create Sustainable Change
        </p>
      </div>
      <img src="/left-leaf.png" alt="Left Leaf" className="absolute left-0 bottom-0 w-24 sm:w-36 md:w-48 lg:w-64"/>
      <img src="/right-leaf.png" alt="Right Leaf" className="absolute right-0 bottom-0 w-24 sm:w-36 md:w-48 lg:w-64"/>
      <img src="/left-star.png" alt="Top Star" className="absolute top-0 left-0 w-12 sm:w-16 md:w-24 lg:w-32"/>
      <img src="/right-star.png" alt="Top Star" className="absolute top-0 right-0 w-12 sm:w-16 md:w-24 lg:w-32"/>
    </div>
  );
}
